    ...
    <div class="container mx-auto px-4">
        <div class="text-center text-white">
            ...
            <p class="text-xl opacity-90 max-w-3xl mx-auto">
                VV Agency - Đối tác tin cậy cho doanh nghiệp trong thời đại số
            </p>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-gray-600 mb-6">
                    ...
                    và phù hợp với ngân sách của từng doanh nghiệp.
                </p>
            </div>
            <div>
                <img src="https://images.pexels.com/photos/3184308/pexels-photo-3184308.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="VV Agency" class="rounded-lg shadow-2xl w-full">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 flex flex-col items-center border-t-4 border-yellow-400">
                ...
                <p class="text-gray-600 text-center">
                    Kim loại tượng trưng cho sự tinh xảo và sắc bén. Chúng tôi đề cao sự tinh tế trong từng câu chữ, thiết kế và ý tưởng. Tinh tế là khả năng cảm nhận sâu sắc nhu cầu của thương hiệu và phản ánh nó bằng ngôn ngữ sáng tạo.
                </p>
            </div>
            <!-- Linh hoạt (Thủy) -->
            <div class="bg-white rounded-lg shadow-lg p-8 flex flex-col items-center border-t-4 border-blue-400">
                ...
                <p class="text-gray-600 text-center">
                    Giống như nước có thể thích nghi với mọi hình dạng, Chúng tôi luôn linh hoạt với mọi yêu cầu và thách thức từ khách hàng. Chúng tôi tin rằng linh hoạt là nền tảng để sáng tạo phù hợp, hiệu quả và đột phá.
                </p>
            </div>
            <!-- Tư duy sáng tạo (Mộc) -->
            <div class="bg-white rounded-lg shadow-lg p-8 flex flex-col items-center border-t-4 border-green-400">
                ...
                <p class="text-gray-600 text-center">
                    Mộc biểu thị sự sống và phát triển. Sáng tạo là dòng chảy không ngừng nuôi dưỡng sự đổi mới trong từng chiến dịch. Tại Việt Vân Agency, mọi thành viên đều chủ động kiến tạo, khám phá góc nhìn mới và không ngừng vươn xa.
                </p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 flex flex-col items-center border-t-4 border-red-400">
                ...
                <p class="text-gray-600 text-center">
                    Ngọn lửa đam mê truyền cảm hứng cho sự kết nối sâu sắc. Chúng tôi xây dựng mối quan hệ hợp tác với khách hàng dựa trên sự chân thành, chia sẻ giá trị và cùng nhau phát triển bền vững.
                </p>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-8 flex flex-col items-center border-t-4 border-yellow-700">
                ...
                <p class="text-gray-600 text-center">
                    Thổ mang đặc tính ổn định và nuôi dưỡng, đại diện cho cam kết đồng hành lâu dài cùng khách hàng. Việt Vân Agency không chỉ cung cấp giải pháp, mà còn lắng nghe, thấu hiểu và trưởng thành cùng thương hiệu.
                </p>
            </div>
        </div>
    </div>
</section>
<!-- Nội dung trang Giới Thiệu kết thúc -->
