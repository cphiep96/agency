...
<main>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-black mb-6">Dịch vụ chăm sóc fanpage của VV Agency</h2>
                    <ul class="space-y-4 text-lg text-black">
                        <li><i class="fas fa-pencil-alt text-[#ff3205] mr-2"></i>Sáng tạo nội dung hấp dẫn, phù hợp từng ngành</li>
                        <li><i class="fas fa-users text-[#ff3205] mr-2"></i>Tăng tương tác, xây dựng cộng đồng trung thành</li>
                        <li><i class="fas fa-bolt text-[#ff3205] mr-2"></i>Chạy quảng cáo, tăng lượt tiếp cận tự nhiên</li>
                        <li><i class="fas fa-headset text-[#ff3205] mr-2"></i>Hỗ trợ quản trị, xử lý khủng hoảng truyền thông</li>
                    </ul>
                    <a href="https://zalo.me/0396693505" class="mt-8 inline-block bg-[#ff3205] hover:bg-[#cc2904] text-white font-bold py-3 px-8 rounded-lg shadow-lg transition-colors">Liên hệ tư vấn</a>
                </div>
            </div>
        </div>
    </section>
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-2xl font-bold text-center text-black mb-8">Lợi ích khi chăm sóc fanpage chuyên nghiệp</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-xl shadow-lg text-center hover:shadow-2xl transition-all duration-300">
                    <i class="fas fa-heart text-3xl text-[#ff3205] mb-4"></i>
                    <h3 class="font-bold text-lg mb-2">Tăng tương tác tự nhiên</h3>
                    <p class="text-black">Nội dung hấp dẫn giúp fanpage phát triển bền vững, tăng lượt thích và bình luận.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-lg text-center hover:shadow-2xl transition-all duration-300">
                    <i class="fas fa-users text-3xl text-[#ff3205] mb-4"></i>
                    <h3 class="font-bold text-lg mb-2">Xây dựng cộng đồng</h3>
                    <p class="text-black">Tạo dựng lòng tin, tăng sự gắn kết giữa thương hiệu và khách hàng.</p>
                </div>
                <div class="bg-white p-6 rounded-xl shadow-lg text-center hover:shadow-2xl transition-all duration-300">
                    <i class="fas fa-shield-alt text-3xl text-[#ff3205] mb-4"></i>
                    <h3 class="font-bold text-lg mb-2">Bảo vệ thương hiệu</h3>
                    <p class="text-black">Quản trị khủng hoảng, bảo vệ hình ảnh thương hiệu trên mạng xã hội.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4 max-w-4xl">
            <h2 class="text-2xl font-bold text-black mb-10 text-center">Quy trình làm việc tại VV Agency</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-all duration-300">
                    <i class="fas fa-handshake text-3xl text-[#ff3205] mb-4"></i>
                    <span class="font-semibold text-lg text-black">Hợp tác</span>
                </div>
                <div class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-all duration-300">
                    <i class="fas fa-search text-3xl text-[#ff3205] mb-4"></i>
                    <span class="font-semibold text-lg text-black">Nghiên cứu SP/DV</span>
                </div>
                <div class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-all duration-300">
                    <i class="fas fa-user-friends text-3xl text-[#ff3205] mb-4"></i>
                    <span class="font-semibold text-lg text-black">Nghiên cứu khách hàng</span>
                </div>
                <div class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-all duration-300">
                    <i class="fas fa-pencil-alt text-3xl text-[#ff3205] mb-4"></i>
                    <span class="font-semibold text-lg text-black">Lên kế hoạch nội dung</span>
                </div>
                <div class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-all duration-300">
                    <i class="fas fa-check-circle text-3xl text-[#ff3205] mb-4"></i>
                    <span class="font-semibold text-lg text-black">Đánh giá chất lượng</span>
                </div>
                <div class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl transition-all duration-300">
                    <i class="fas fa-trophy text-3xl text-[#ff3205] mb-4"></i>
                    <span class="font-semibold text-lg text-black">Kết quả</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4 max-w-6xl">
            <h2 class="text-2xl font-bold text-center text-black mb-8">Bảng giá dịch vụ chăm sóc Fanpage</h2>
      ...
      <table class="min-w-full bg-white rounded-xl shadow-lg text-sm">
                    ...
                    <tbody class="text-black">
                        <tr class="border-b">
                            ...
                            <td class="py-2 px-2 text-center">2.000.000 đ</td>
                            <td class="py-2 px-2 text-center">6.000.000 đ</td>
                            <td class="py-2 px-2 text-center">10.000.000 đ</td>
                        </tr>
                        <tr class="border-b">
                            <td class="py-2 px-2">Định hướng<br> tư vấn nội dung</td>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="py-2 px-2 text-center">4 bài</td>
                            <td class="py-2 px-2 text-center">15 bài</td>
                            <td class="py-2 px-2 text-center">30 bài</td>
                        </tr>
                        <tr class="border-b">
                            <td class="py-2 px-2">Hình ảnh kèm <br> theo nội dung</td>
                            <td class="py-2 px-2 text-center"><i class="fas fa-check text-green-500"></i></td>
                            <td class="py-2 px-2 text-center"><i class="fas fa-check text-green-500"></i></td>
                            <td class="py-2 px-2 text-center"><i class="fas fa-check text-green-500"></i></td>
                        </tr>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="py-2 px-2 text-center"><i class="fas fa-times text-red-500"></i></td>
                            <td class="py-2 px-2 text-center"><i class="fas fa-times text-red-500"></i></td>
                            <td class="py-2 px-2 text-center"><i class="fas fa-check text-green-500"></i></td>
                        </tr>
                        <tr class="border-b">
                        ...
                        <tr class="border-b">
                            <td class="py-2 px-2">Tư vấn <br> chạy quảng cáo</td>
                            <td class="py-2 px-2 text-center"><i class="fas fa-times text-red-500"></i></td>
                            <td class="py-2 px-2 text-center"><i class="fas fa-check text-green-500"></i></td>
                            <td class="py-2 px-2 text-center"><i class="fas fa-check text-green-500"></i></td>
                        </tr>
                ...
                <td class="py-2 px-2 text-center">
                    <div class="flex justify-center">
                        <a href="https://zalo.me/0396693505" class="inline-block bg-[#ff3205] hover:bg-[#cc2904] text-white py-1 px-2 w-auto rounded-lg shadow transition-colors text-xs">Liên hệ tư vấn</a>
                    </div>
                </td>
                <td class="py-2 px-2 text-center">
                    <div class="flex justify-center">
