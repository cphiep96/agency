...
<main>
  ...
  <div class="container mx-auto px-4">
    <h2 class="text-2xl font-bold text-center text-gray-800 mb-8">Giải pháp quảng cáo Facebook – Chìa khóa tiếp cận đúng khách hàng, đúng thời điểm</h2>
...
<section class="py-12 bg-white">
  <div class="container mx-auto px-4">
    <h2 class="text-2xl font-bold text-center text-gray-800 mb-8">Bảng giá chạy quảng cáo Facebook tại VV Agency</h2>
    <div class="overflow-x-auto">
      <table class="min-w-full bg-white rounded-xl shadow-lg">
        ...
        <tbody class="text-center">
          ...
          <tr>
            <td class="py-2 px-4 border-b text-left">Tạo Fanpage miễn phí</td>
            <td class="py-2 px-4 border-b"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-4 border-b"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-4 border-b"><i class="fas fa-check text-green-500"></i></td>
          </tr>
          <tr class="bg-blue-50">
            <td class="py-2 px-4 border-b text-left">Chỉnh sửa mục tiêu</td>
            <td class="py-2 px-4 border-b"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-4 border-b"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-4 border-b"><i class="fas fa-check text-green-500"></i></td>
          </tr>
          <tr>
            <td class="py-2 px-4 border-b text-left">Tối ưu chiến dịch</td>
            <td class="py-2 px-4 border-b"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-4 border-b"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-4 border-b"><i class="fas fa-check text-green-500"></i></td>
          </tr>
