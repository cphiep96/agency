...
<main>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-[#ff3205] text-white rounded-xl shadow-2xl p-8 flex flex-col relative transform md:scale-105 transition-transform transition-shadow duration-300 hover:shadow-[#ff3205]/50 hover:scale-110">
                    ...
                    <p class="text-center text-white/80 mb-6">Dành cho doanh nghiệp vừa và nhỏ</p>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-center text-gray-800 mb-12">VV Agency thiết kế website đa lĩnh vực</h2>
                ...
                <div class="space-y-4" id="faq-accordion">
                    ...
                    <div class="bg-white rounded-xl shadow-lg">
                        <button class="faq-toggle w-full text-left p-6 flex justify-between items-center">
                            <span class="text-lg font-semibold text-gray-800">Thời gian triển khai và hoàn tất một website sẽ là bao nhiêu ngày?</span>
                    ...
                    <div class="bg-white rounded-xl shadow-lg">
                        <button class="faq-toggle w-full text-left p-6 flex justify-between items-center">
                            <span class="text-lg font-semibold text-gray-800">Tôi có thể tự thay đổi nội dung trên website khi cần không?</span>
                            <i class="fas fa-chevron-down text-[#ff3205] transform transition-transform"></i>
                        </button>
                        <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
                     ...
                     <div class="bg-white rounded-xl shadow-lg">
                        <button class="faq-toggle w-full text-left p-6 flex justify-between items-center">
                            <span class="text-lg font-semibold text-gray-800">Chính sách bảo hành và dịch vụ hỗ trợ khách hàng được áp dụng ra sao?</span>
                            <i class="fas fa-chevron-down text-[#ff3205] transform transition-transform"></i>
                        </button>
                        <div class="faq-content max-h-0 overflow-hidden transition-all duration-500 ease-in-out">
