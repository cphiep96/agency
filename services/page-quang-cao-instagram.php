...
<main>
    ...
    <section class="py-12 bg-white">
      <div class="container mx-auto px-4">
        <h2 class="text-2xl font-bold text-center text-gray-800 mb-10">Quy trình triển khai dự án Instagram tại VV Agency</h2>
...
<section class="py-12 bg-gray-50">
  <div class="container mx-auto px-4">
    <h2 class="text-2xl font-bold text-center text-gray-800 mb-8">Bảng giá dịch vụ quảng cáo Instagram</h2>
