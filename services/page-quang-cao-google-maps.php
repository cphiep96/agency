    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 class="text-3xl font-bold text-black mb-6">Vì sao nên đầu tư Google Maps?</h2>
                    <ul class="space-y-4 text-lg text-black">
                        <li><i class="fas fa-check-circle text-[#ff3205] mr-2"></i>Tăng độ phủ thương hiệu tại khu vực kinh doanh.</li>
                        <li><i class="fas fa-check-circle text-[#ff3205] mr-2"></i>Tăng cơ hội tiếp cận khách hàng ngay tại điểm bán.</li>
                        <li><i class="fas fa-check-circle text-[#ff3205] mr-2"></i>Tạo dựng hình ảnh chuyên nghiệp nhờ review xác thực.</li>
                        <li><i class="fas fa-check-circle text-[#ff3205] mr-2"></i>Chi phí thấp, mang lại kết quả nhanh hơn SEO website.</li>
                    </ul>
                </div>
                <div>
                    <h2 class="text-3xl font-bold text-black mb-6">Vì sao nên hợp tác cùng VV Agency?</h2>
                    <ul class="space-y-4 text-lg text-black">
                        <li><i class="fas fa-rocket text-[#ff3205] mr-2"></i>Tối ưu chuẩn Google giúp doanh nghiệp nổi bật.</li>
                        <li><i class="fas fa-chart-pie text-[#ff3205] mr-2"></i>Hiệu quả được chứng minh bằng số liệu cụ thể.</li>
                        <li><i class="fas fa-shield-alt text-[#ff3205] mr-2"></i>Giải pháp an toàn, minh bạch, chỉ dùng đánh giá thực tế.</li>
                    </ul>
...
<section class="py-12 bg-white">
  <div class="container mx-auto px-4 max-w-4xl">
    <h2 class="text-2xl font-bold text-center text-black mb-8">Bảng giá dịch vụ Google Maps tại VV Agency</h2>
        ...
        <tbody class="text-black">
          ...
          <tr class="bg-gray-50">
            ...
            <td class="py-3 px-3 text-center">
                <a href="https://zalo.me/0396693505" class="inline-block bg-[#ff3205] hover:bg-[#cc2904] text-white py-2 px-4 rounded-lg shadow transition-colors text-xs font-bold">Liên hệ tư vấn</a>
            </td>
            <td class="py-3 px-3 text-center">
                <a href="https://zalo.me/0396693505" class="inline-block bg-[#ff3205] hover:bg-[#cc2904] text-white py-2 px-4 rounded-lg shadow transition-colors text-xs font-bold">Liên hệ tư vấn</a>
            </td>
