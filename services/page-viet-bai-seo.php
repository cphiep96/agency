      ...
      <table class="min-w-full bg-white rounded-xl shadow-lg text-sm">
        ...
        <tbody class="text-black">
          ...
          <tr class="border-b bg-gray-50">
            <td class="py-2 px-3">Độ dài bài viết</td>
            <td class="py-2 px-3 text-center">500 - 700 từ/bài</td>
            <td class="py-2 px-3 text-center">700 - 1.000 từ/bài</td>
            <td class="py-2 px-3 text-center">1.000 - 2.000 từ/bài</td>
          </tr>
          <tr class="border-b">
            <td class="py-2 px-3">Tư vấn</td>
            <td class="py-2 px-3 text-center">Miễn phí</td>
            <td class="py-2 px-3 text-center">Miễn phí</td>
            <td class="py-2 px-3 text-center">Miễn phí</td>
          </tr>
          <tr class="border-b bg-gray-50">
            <td class="py-2 px-3">Nghiên cứu từ khóa</td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
          </tr>
          <tr class="border-b">
            <td class="py-2 px-3">Xây dựng dàn ý</td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
          </tr>
          <tr class="border-b bg-gray-50">
            <td class="py-2 px-3">Tối ưu SEO</td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
          </tr>
          <tr class="border-b">
            <td class="py-2 px-3">Tỉ lệ unique</td>
            <td class="py-2 px-3 text-center">>90%</td>
            <td class="py-2 px-3 text-center">>90%</td>
            <td class="py-2 px-3 text-center">>90%</td>
          </tr>
          <tr class="border-b bg-gray-50">
            <td class="py-2 px-3">Hình ảnh</td>
            <td class="py-2 px-3 text-center">1 hình ảnh</td>
            <td class="py-2 px-3 text-center">2 - 3 hình ảnh</td>
            <td class="py-2 px-3 text-center">4 - 5 hình ảnh</td>
          </tr>
          <tr class="border-b">
            <td class="py-2 px-3">Báo cáo</td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
            <td class="py-2 px-3 text-center"><i class="fas fa-check text-green-500"></i></td>
          </tr>
